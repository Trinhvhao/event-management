    ...
    <div className="bg-brandBlue py-20 border-y border-white/5 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 divide-x-0 md:divide-x divide-white/10">
            <Counter value={50} suffix="+" label="Trường Đại học" />
            <Counter value={1.5} suffix="M+" label="Sinh viên active" decimals={1} />
            <Counter value={10} suffix="K+" label="Sự kiện / năm" />
            <Counter value={99.9} suffix="%" label="Uptime Cam kết" decimals={1} />
        </div>
      </div>
    </div>
  );
