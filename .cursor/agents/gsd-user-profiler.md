...
<reference>
@D:/LibraryCode/event-management/.cursor/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `D:/LibraryCode/event-management/.cursor/get-shit-done/references/user-profiling.md` to load:
