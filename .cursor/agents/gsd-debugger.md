...
<required_reading>
@D:/LibraryCode/event-management/.cursor/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@D:/LibraryCode/event-management/.cursor/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/LibraryCode/event-management/.cursor
                  → checks D:/LibraryCode/event-management/.cursor/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/LibraryCode/event-management/.cursor/get-shit-done
                  → writes to D:/LibraryCode/event-management/.cursor/get-shit-done/hooks/
...
@D:/LibraryCode/event-management/.cursor/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/LibraryCode/event-management/.cursor/get-shit-done/references/common-bug-patterns.md
