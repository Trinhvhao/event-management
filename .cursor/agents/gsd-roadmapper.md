...
Reference full template: `D:/LibraryCode/event-management/.cursor/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/LibraryCode/event-management/.cursor/get-shit-done/templates/state.md`.
