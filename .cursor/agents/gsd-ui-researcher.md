...
Use template from `D:/LibraryCode/event-management/.cursor/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `D:/LibraryCode/event-management/.cursor/get-shit-done/templates/UI-SPEC.md`
