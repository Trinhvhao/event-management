...
Read and follow `D:/LibraryCode/event-management/.cursor/get-shit-done/workflows/transition.md`.
...
- Follow @D:/LibraryCode/event-management/.cursor/get-shit-done/workflows/diagnose-issues.md
