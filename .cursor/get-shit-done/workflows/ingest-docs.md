...
```bash
INIT=$(node "D:/LibraryCode/event-management/.cursor/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "D:/LibraryCode/event-management/.cursor/get-shit-done/bin/gsd-tools.cjs" commit \
