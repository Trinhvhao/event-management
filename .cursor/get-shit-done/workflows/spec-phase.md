...
```bash
INIT=$(node "D:/LibraryCode/event-management/.cursor/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @D:/LibraryCode/event-management/.cursor/get-shit-done/templates/spec.md.
