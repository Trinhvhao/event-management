...
```markdown
Read D:/LibraryCode/event-management/.cursor/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/LibraryCode/event-management/.cursor/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/LibraryCode/event-management/.cursor/agents/gsd-ui-checker.md for instructions.
