...
```
Task(
  prompt="Read D:/LibraryCode/event-management/.cursor/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/LibraryCode/event-management/.cursor/get-shit-done/templates/VALIDATION.md`
