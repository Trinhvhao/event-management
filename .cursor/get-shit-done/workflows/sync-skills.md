...
INSTALL_JS_GLOBAL="D:/LibraryCode/event-management/.cursor/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node D:/LibraryCode/event-management/.cursor/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
