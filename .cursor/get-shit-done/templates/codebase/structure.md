...
- Usage: Reference from command with `@D:/LibraryCode/event-management/.cursor/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to D:/LibraryCode/event-management/.cursor/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/LibraryCode/event-management/.cursor/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
